...
// _TODO: persist new status in db!!! - DONE
...
// _TODO: toss peers-online, respond to "peers" like this:
// [ peerA: { status: 'online' }, peerB: { status: 'offline' } ] !!! - DONE
const createPeers = db => (meta_stream, metadata, cb) => {
  debug('::peers::')
...
const createLogoff =
  ...
  // TODO:
  // validate metadata
  // remove metadata.user from logged_in_users
